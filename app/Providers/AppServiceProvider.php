...
use App\Observers\ExternalMediaObserver;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // --- 3. REGISTRO DO SENTINELA (NOVO) ---
        // Ativa o Observer que dispara o alerta de e-mail para você
        ExternalMedia::observe(ExternalMediaObserver::class);
    }
}